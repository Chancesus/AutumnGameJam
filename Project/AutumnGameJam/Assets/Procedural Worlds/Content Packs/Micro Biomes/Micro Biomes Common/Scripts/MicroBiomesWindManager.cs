using UnityEngine;
    ...
    public class MicroBiomesWindManager : MonoBehaviour
    {
        #region Variables
        ...
        [HideInInspector] public Vector4 windGlobals;
        [HideInInspector]  public Vector4 windGlobalsB;
        ...
        [SerializeField]
        [HideInInspector]  private WindZone m_windZone;
        ...
        {
            MicroBiomesWindManager manager = FindObjectOfType<MicroBiomesWindManager>();
            if (manager != null)
            {
